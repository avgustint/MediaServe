...
export interface TranslationKeys {
  ...
  showChordsEverywhere: string;
  showChordsLocally: string;
  hideChords: string;
  increaseChordTransposition: string;
  decreaseChordTransposition: string;
  resetChordTransposition: string;
...
const translations: Record<SupportedLocale, TranslationKeys> = {
  'en-GB': {
    ...
    confirmRemovePage: 'Are you sure you want to remove this page from the song? You need to save the item for the change to be permanent.',
    ...
    libraryItemAdded: 'Library item added successfully',
    playlistDeleted: 'Playlist deleted successfully',
    playlistSaved: 'Playlist saved successfully',
    errorDeletingItem: 'Error deleting item. Please try again.',
    errorSavingPlaylist: 'Error saving playlist. Please try again.',
    ...
    showChordsEverywhere: 'Show chords everywhere',
    showChordsLocally: 'Show chords locally',
    hideChords: 'Hide chords',
    increaseChordTransposition: 'Transpose chords up (half tone)',
    decreaseChordTransposition: 'Transpose chords down (half tone)',
    resetChordTransposition: 'Reset chord transposition',
    ...
    noItemsInCollection: 'No items in collection.',
    addItemToPlaylist: 'Add Item to Playlist',
  ...
  'sl-SI': {
    ...
    showChordsEverywhere: 'Prikaži akorde povsod',
    showChordsLocally: 'Prikaži akorde lokalno',
    hideChords: 'Skrij akorde',
    ...
    collectionDeleted: 'Zbirka je bila uspešno izbrisana',
  ...
  'it-IT': {
    ...
    confirmRemovePage: 'Sei sicuro di voler rimuovere questa pagina dalla canzone? Devi salvare l\'elemento affinché la modifica sia permanente.',
    ...
    libraryItemAdded: 'Elemento biblioteca aggiunto con successo',
    playlistDeleted: 'Playlist eliminata con successo',
    playlistSaved: 'Playlist salvata con successo',
    errorDeletingItem: 'Errore durante l\'eliminazione. Riprova.',
    errorSavingPlaylist: 'Errore durante il salvataggio della playlist. Riprova.',
    editPages: 'Modifica pagine',
    allPagesSelected: 'Tutte le pagine selezionate',
    ...
    showChordsEverywhere: 'Mostra accordi ovunque',
    showChordsLocally: 'Mostra accordi localmente',
    hideChords: 'Nascondi accordi',
    increaseChordTransposition: 'Trasporta accordi su (semitono)',
    decreaseChordTransposition: 'Trasporta accordi giù (semitono)',
    resetChordTransposition: 'Reimposta trasporto accordi',
    ...
    noItemsInCollection: 'Nessun elemento nella collezione.',
    addItemToPlaylist: 'Aggiungi Elemento alla Playlist',
    ...
    collectionDeleted: 'Collezione eliminata con successo',
