...
import { LocationsService, Location } from "../auth/services/locations.service";
...
export class UserProfileComponent implements OnInit {
  ...
  saveProfile(): void {
    ...
    const userData: Partial<import("../settings/services/settings.service").User> = {
      name: this.editName,
      email: encodedEmail,
      ...
      next: (updatedUser) => {
        ...
        if (currentUser) {
          ...
          if (updatedUser.locale && this.translationService.getCurrentLocale() !== updatedUser.locale) {
            this.translationService.setLocale(updatedUser.locale as import("../../core/services/translation.service").SupportedLocale);
          }
        }
        this.isEditing = false;
      },
